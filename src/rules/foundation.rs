        ...
        if ctx.agents_md_content.is_some() {
            ...
            self.warn(
                ...
                Suggestion {
                    ...
                    description: "Run `claude-native --init` to generate AGENTS.md. Backed by Anthropic, OpenAI, Cursor, and Copilot — the universal standard for AI agent instructions.".into(),
                    effort: Effort::Minutes,
                },
            )
        }
